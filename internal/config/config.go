...
func MakeConfig() *Config {
	...
	flag.StringVar(&config.FlagDBConnectionAddress, "d", "host=postgres port=5432 user=postgres password=vbhjyjdrf dbname=URLRecords sslmode=disable", "database connection address")
