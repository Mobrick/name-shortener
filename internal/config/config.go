...
func MakeConfig() *Config {
	...
	flag.StringVar(&config.FlagDBConnectionAddress, "d", "host=db user=postgres password=vbhjyjdrf dbname=URLRecords sslmode=disable", "database connection address")
